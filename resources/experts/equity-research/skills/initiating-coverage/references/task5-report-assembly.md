...
**CRITICAL PRINCIPLE 2**: Use the DOCX and XLSX skills to programmatically create the report.

**REQUIRED TOOLS** (the DOCX and XLSX skills are required):
...
**DO**: Use the DOCX and XLSX skills to open files, extract data, and create the DOCX report
...
**Open and inspect files using the available file tools and skills:**
...
**Use the XLSX skill to extract data from Excel files:**
...
Use the DOCX and XLSX skills to:
...
**Throughout the entire assembly process, use the DOCX and XLSX skills with actual file operations:**
...
**Do NOT manually copy/paste. Use the built-in skills to:**
