...
A ZeroWork skill for searching, downloading, and customizing [Lucide icons](https://lucide.dev/) - a beautiful & consistent icon library with 1000+ icons.
...
```bash
cd ~/.zerowork/skills/lucide-icons/scripts
npm install
```
...
```bash
# Using node directly
node ~/.zerowork/skills/lucide-icons/scripts/lucide.js <command>

# Or create an alias in your shell config
alias lucide="node ~/.zerowork/skills/lucide-icons/scripts/lucide.js"
```
...
- Icon metadata is cached in `~/.zerowork/skills/lucide-icons/cache/`
- Cache TTL: 24 hours
...
## Integration with ZeroWork

When using with ZeroWork, you can ask:

> "Search for heart-related icons"

ZeroWork will execute:
```bash
node ~/.zerowork/skills/lucide-icons/scripts/lucide.js search heart
```
...
ZeroWork will execute:
```bash
node ~/.zerowork/skills/lucide-icons/scripts/lucide.js download heart \
  --format svg,react \
  --output ./src/icons/
```
...
```bash
cd ~/.zerowork/skills/lucide-icons/scripts && npm install
```
