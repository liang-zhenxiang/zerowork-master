...
def start_server(relative_path):
    ...
    plugin_root = os.environ.get('ZEROWORK_PLUGIN_ROOT', '')
    print(f"[start_server] ZEROWORK_PLUGIN_ROOT: {plugin_root}")
    subprocess.run(
...
def capture_screenshot(relative_path):
    ...
    plugin_root = os.environ.get('ZEROWORK_PLUGIN_ROOT', '')
    project_dir = os.environ.get('ZEROWORK_PROJECT_DIR', '')
    print(f"[capture_screenshot] ZEROWORK_PLUGIN_ROOT: {plugin_root}")
    print(f"[capture_screenshot] ZEROWORK_PROJECT_DIR: {project_dir}")
    subprocess.run(
