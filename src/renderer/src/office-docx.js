import { r as reactExports, j as jsxRuntimeExports, S as Skeleton, E as ErrorState } from "./app.js";
import { o } from "./vendor-jszip-2.js";
...
class OpenXmlPackage {
  ...
  static async load(input, options) {
    const zip = await o.loadAsync(input);
...
function DocxPreview({ url }) {
  ...
  reactExports.useEffect(() => {
    ...
    const updateZoom = () => {
      const firstSection = container.querySelector("section.docx");
      if (firstSection === null) return;
      const paperWidth = firstSection.offsetWidth;
      const panelWidth = scroll.clientWidth;
      container.style.zoom = paperWidth > 0 && panelWidth > 0 && panelWidth < paperWidth ? String(panelWidth / paperWidth) : "";
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: scrollRef, className: "preview-office-content office-docx-scroll", children: [
    loading && /* 纸张骨架而非居中转圈：docx 的形状完全可预知（灰底 + 居中白纸），
    骨架连"白纸多大、出现在哪"一起说清楚，解析完成时是同尺寸替换。 */
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: SKELETON_PAD_STYLE, role: "status", "aria-label": "正在解析文档", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: PAPER_STYLE, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "34%", height: 16 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "96%", height: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "92%", height: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "97%", height: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "78%", height: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "94%", height: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "88%", height: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { width: "52%", height: 10 })
    ] }) }),
    error !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorState, { message: `文档解析失败：${error}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: containerRef, className: "office-docx", hidden: loading || error !== void 0 })
  ] });
}
export {
  DocxPreview as default
};
